          ...
          <div className="text-white max-w-2xl">
            ...
            <div className="space-x-4">
              <button 
                ...
                className="bg-rose-500 hover:bg-rose-600 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
              ...
              <button 
                ...
                className="bg-transparent border-2 border-white hover:bg-white/10 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300"
              >
                View Offers
              </button>
            </div>
